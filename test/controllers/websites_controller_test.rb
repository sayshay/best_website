...
class WebsitesControllerTest < ActionController::TestCase
  ...
  test "should create website" do
    assert_difference('Website.count') do
      post :create, website: { description: @website.description, features: @website.features, industry: @website.industry, name: @website.name, twitter: @website.twitter }
    end
  ...
  test "should update website" do
    patch :update, id: @website, website: { description: @website.description, features: @website.features, industry: @website.industry, name: @website.name, twitter: @website.twitter }
    assert_redirected_to website_path(assigns(:website))
  end
